...
import com.cutler.template.transload.dao.InnerDataBaseHelper;
...
public class UploadListDAO {
    ...
    public static final String CREATE_TAB = "CREATE TABLE IF NOT EXISTS " + KEY_TAB_NAME +
            ...
            + KEY_LOCAL_PATH + " , " + KEY_URL + " , " + KEY_UPLOAD_TYPE + " , "
    ...
    private String[] allColumns = new String[]{KEY_ID, KEY_LOCAL_PATH, KEY_STATE, KEY_FINISHED_TIME, KEY_URL, KEY_UPLOAD_TYPE, KEY_PARAMS};
