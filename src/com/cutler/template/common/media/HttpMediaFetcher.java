...
public class HttpMediaFetcher extends MediaFetcher {
	// 具有3个线程的线程池。
...
//			CommonUtils.sendThrowableToServer(new Exception(IOUtil.getDiskCacheDir(MainApplication.getInstance(), "media").toString(),e));TODO
		}
	}
