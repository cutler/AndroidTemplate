...
import com.cutler.template.common.InnerSystemParams;
...
public class LocationService {
    ...
    public static void start() {
        if (!isStared()) {
            locationClient = new LocationClient(Template.getApplication());
    ...
    final static class MyLocationListener implements BDLocationListener {
        public void onReceiveLocation(BDLocation location) {
            ...
            // 将定位信息保存到本地。
            InnerSystemParams.setLocation(location.getLongitude(), location.getLatitude());
        }
    }
