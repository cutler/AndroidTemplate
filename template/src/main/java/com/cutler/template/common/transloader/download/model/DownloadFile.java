...
public class DownloadFile extends TransferableFile {
    ...
    private boolean deleteCacheFile;    // 是否删除本地的缓存文件。
    ...
    public void setDeleteCacheFile(boolean deleteCacheFile) {
        this.deleteCacheFile = deleteCacheFile;
    }
    ...
    public static DownloadFile parseCursor(Cursor c) {
        ...
        try {
            ...
            inst.useCache = Boolean.parseBoolean(c.getString(c.getColumnIndex(DownloadListDAO.KEY_USECACHE)));
            inst.deleteCacheFile = Boolean.parseBoolean(c.getString(c.getColumnIndex(DownloadListDAO.KEY_DELETECACHEFILE)));
        } catch (Exception e) {
            inst = null;
            e.printStackTrace();
        }
    ...
    public ContentValues toContentValues() {
        ...
        values.put(DownloadListDAO.KEY_USECACHE, String.valueOf(useCache));
        values.put(DownloadListDAO.KEY_DELETECACHEFILE, String.valueOf(deleteCacheFile));
        return values;
    }
